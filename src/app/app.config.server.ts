  ...
  providers: [
    ...
    // },
    {
      ...
      useFactory: (http: HttpClient) => ({
        ...
        [NbTransLang.EN]: () => http.get('http://localhost:4000/assets/localization/en/translations.json'),
        // [NbTransLang.ZH_CN]: () => http.get('./assets/localization/zh-CN/translations.json').toPromise(),
        [NbTransLang.ZH_CN]: () => http.get('http://localhost:4000/assets/localization/zh-CN/translations.json'),
      }),
      deps: [HttpClient]
    },
